...
class Recommend(object):
    def __init__(self):
        ...
        # self.fin = 'file/grouplen/ratings.dat'
        self.in_dir = 'file/grouplen/test'
        self.fin = '%s/ratingsTest'%self.in_dir
    ...
    def _save_matrix_w(self):
        ...
        :return:
        """
        f = open('%s/matrixW.txt'%self.in_dir, 'wb')
        pickle.dump(self.W, f)
        f.close()

    def load_matrix_w(self):  # 载入大概需要7.96s
        fW = '%s/matrixW.txt'%self.in_dir
